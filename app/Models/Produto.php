...
class Produto extends Model
{
    ...
    protected $fillable = ['codprod', 'nome', 'descrcompleta', 'referencia', 'codgrupo', 'unidade', 'codbarras', 'preco', 'fotoprod', 'usagrade', 'estoque', 'usalote', 'inativo', 'dtmodificacao', 'quantun'];
